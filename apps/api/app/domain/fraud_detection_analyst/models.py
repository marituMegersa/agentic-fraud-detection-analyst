...
class AgenticFraudDetectionAnalystSession(Base):
    __tablename__ = "fraud_detection_analyst_sessions"
...
class AgenticFraudDetectionAnalystItem(Base):
    __tablename__ = "fraud_detection_analyst_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("fraud_detection_analyst_sessions.id"))
